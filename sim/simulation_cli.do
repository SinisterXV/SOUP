...
quietly set register_file_values [examine sim:/tb_dlx/dlx_inst/dtpth/rf/registers]
# puts $register_file_values
puts $dump_file "REGISTER FILE"
puts $dump_file $register_file_values 
puts $dump_file ""
puts "Dump of the DRAM..."
quietly set dram_values [examine sim:/tb_dlx/dlx_inst/dtpth/d_mem/dram_memory]
# puts $dram_values
puts $dump_file "DRAM"
